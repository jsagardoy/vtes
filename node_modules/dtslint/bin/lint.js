...
function range(minVersion, maxVersion) {
    ...
    const minIdx = definitelytyped_header_parser_1.TypeScriptVersion.supported.indexOf(minVersion);
    assert(minIdx >= 0);
    const maxIdx = definitelytyped_header_parser_1.TypeScriptVersion.supported.indexOf(maxVersion);
    assert(maxIdx >= minIdx);
    return definitelytyped_header_parser_1.TypeScriptVersion.supported.slice(minIdx, maxIdx + 1);
}
