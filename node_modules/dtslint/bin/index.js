...
function runTests(dirPath, onlyTestTsNext, expectOnly, tsLocal) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (onlyTestTsNext || tsLocal) {
            const tsVersion = tsLocal ? "local" : definitelytyped_header_parser_1.TypeScriptVersion.latest;
            ...
            function getTsVersion(i) {
                return i === typesVersions.length
                    ? definitelytyped_header_parser_1.TypeScriptVersion.latest
                    : util_1.assertDefined(definitelytyped_header_parser_1.TypeScriptVersion.previous(typesVersions[i]));
            }
        }
    });
}
